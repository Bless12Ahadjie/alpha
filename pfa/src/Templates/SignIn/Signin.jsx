...
const Signin = () => {
  return (
    ...
    <div className='signin-wrapper'>
        ...
        <div>
                <p className='Header-txt'>Sign in to Alpha</p>
                <p className='first-txt'>Don't have an account? <Link to='/' className='sign-in'>Sign Up</Link></p>
            </div>
            ...
            <Link className='gmail-txt'>Sign in with Gmail</Link>
            </div>
            ...
            <input className='input-signup' type="text" name="" id="" placeholder='Password'/>
             <Button className='btn' btnName="Sign In"/>
        </div>
