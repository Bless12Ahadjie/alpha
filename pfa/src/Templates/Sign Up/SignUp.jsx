...
<div className='signup-wrapper'>
        <div>
            <p className='Header-txt'>Sign up to Alpha</p>
            <p className='first-txt'>Already have an account? <Link to='/sign-in' className='sign-in'>Sign In</Link></p>
        </div>

        <div className='google-signup'>
        <svg className='Gmail-logo' cls xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <Link className='gmail-txt'>Sign up with Gmail</Link>
        </div>
        ...
        <input className='input-signup' type="text" name="" id="" placeholder='Name'/>
        <input className='input-signup' type="text" name="" id="" placeholder='Email Address'/>
        <input className='input-signup' type="text" name="" id="" placeholder='Password'/>
        <input className='google-signup' type="text" name="" id="" placeholder='Confirm Password'/>
         <Button className='btn' btnName="Sign Up"/>
